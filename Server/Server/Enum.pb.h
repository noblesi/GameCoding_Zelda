...
enum PlayerType : int {
  ...
  PlayerType_INT_MIN_SENTINEL_DO_NOT_USE_ = numeric_limits<int32_t>::min(),
  PlayerType_INT_MAX_SENTINEL_DO_NOT_USE_ = numeric_limits<int32_t>::max()
};
...
template<typename T>
inline const string& PlayerType_Name(T enum_t_value) {
  static_assert(::is_same<T, PlayerType>::value ||
    ::is_integral<T>::value,
...
enum OBJECT_TYPE : int {
  ...
  OBJECT_TYPE_INT_MIN_SENTINEL_DO_NOT_USE_ = numeric_limits<int32_t>::min(),
  OBJECT_TYPE_INT_MAX_SENTINEL_DO_NOT_USE_ = numeric_limits<int32_t>::max()
};
...
template<typename T>
inline const string& OBJECT_TYPE_Name(T enum_t_value) {
  static_assert(::is_same<T, OBJECT_TYPE>::value ||
    ::is_integral<T>::value,
...
enum OBJECT_STATE_TYPE : int {
  ...
  OBJECT_STATE_TYPE_INT_MIN_SENTINEL_DO_NOT_USE_ = numeric_limits<int32_t>::min(),
  OBJECT_STATE_TYPE_INT_MAX_SENTINEL_DO_NOT_USE_ = numeric_limits<int32_t>::max()
};
...
template<typename T>
inline const string& OBJECT_STATE_TYPE_Name(T enum_t_value) {
  static_assert(::is_same<T, OBJECT_STATE_TYPE>::value ||
    ::is_integral<T>::value,
...
enum DIR_TYPE : int {
  ...
  DIR_TYPE_LEFT = 2,
  DIR_TYPE_RIGHT = 3,
  DIR_TYPE_INT_MIN_SENTINEL_DO_NOT_USE_ = numeric_limits<int32_t>::min(),
  DIR_TYPE_INT_MAX_SENTINEL_DO_NOT_USE_ = numeric_limits<int32_t>::max()
};
...
template<typename T>
inline const string& DIR_TYPE_Name(T enum_t_value) {
  static_assert(::is_same<T, DIR_TYPE>::value ||
    ::is_integral<T>::value,
...
template <> struct is_proto_enum< ::Protocol::PlayerType> : ::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Protocol::PlayerType>() {
  return ::Protocol::PlayerType_descriptor();
}
template <> struct is_proto_enum< ::Protocol::OBJECT_TYPE> : ::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Protocol::OBJECT_TYPE>() {
  return ::Protocol::OBJECT_TYPE_descriptor();
}
template <> struct is_proto_enum< ::Protocol::OBJECT_STATE_TYPE> : ::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Protocol::OBJECT_STATE_TYPE>() {
  return ::Protocol::OBJECT_STATE_TYPE_descriptor();
}
template <> struct is_proto_enum< ::Protocol::DIR_TYPE> : ::true_type {};
template <>
