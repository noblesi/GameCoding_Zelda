...
class BuffData final :
 ...
 private:
  ...
  struct Impl_ {
    ...
    mutable atomic<int> _victims_cached_byte_size_;
    uint64_t buffid_;
    float remaintime_;
...
class ObjectInfo final :
 ...
 public:
  ...
  template <typename ArgT0 = const string&, typename... ArgT>
  void set_name(ArgT0&& arg0, ArgT... args);
  string* mutable_name();
  PROTOBUF_NODISCARD string* release_name();
  void set_allocated_name(string* name);
  private:
  const string& _internal_name() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_name(const string& value);
...
inline const string& ObjectInfo::name() const {
...
inline string* ObjectInfo::mutable_name() {
  string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:Protocol.ObjectInfo.name)
  return _s;
}
inline const string& ObjectInfo::_internal_name() const {
  return _impl_.name_.Get();
}
inline void ObjectInfo::_internal_set_name(const string& value) {
  
  _impl_.name_.Set(value, GetArenaForAllocation());
}
inline string* ObjectInfo::_internal_mutable_name() {
  
  return _impl_.name_.Mutable(GetArenaForAllocation());
}
inline string* ObjectInfo::release_name() {
  // @@protoc_insertion_point(field_release:Protocol.ObjectInfo.name)
  return _impl_.name_.Release();
}
inline void ObjectInfo::set_allocated_name(string* name) {
  if (name != nullptr) {
